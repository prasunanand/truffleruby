...
Instructions:
  1. Run bundle install command with workarounds. E.g.:
      GEM_HOME=/Users/brandonfish/Documents/truffle_gem_home ../../truffleruby/bin/truffleruby -rbundler-workarounds -S bundle install
  2. Try running gem tests, e.g.:
      GEM_HOME=/Users/brandonfish/Documents/truffle_gem_home ../../truffleruby/bin/truffleruby -rbundler-workarounds -S bundle exec rake
HEREDOC
